...
const (
	...
	CodeLedgerInvalidTimezone = "LDG001"
	CodeLedgerInvalidStartDay = "LDG002"
	CodeLedgerUnknownCurrency = "LDG003"

	CodeWalletNotFound      = "WLT001"
	CodeWalletInvalidName   = "WLT002"
	CodeWalletAlreadyExists = "WLT003"
	CodeWalletInvalidKind   = "WLT004"
	CodeWalletInUse         = "WLT005"
	CodeWalletAmbiguousName = "WLT006"
	CodeWalletArchived      = "WLT007"

	CodeTxCategoryNotFound      = "CTG001"
	CodeTxCategoryInvalidName   = "CTG002"
	CodeTxCategoryAlreadyExists = "CTG003"
	CodeTxCategoryInvalidKind   = "CTG004"
	CodeTxCategoryInUse         = "CTG005"
	CodeTxCategoryAmbiguousName = "CTG006"

	CodeTransactionNotFound             = "TXN001"
	CodeTransactionInvalidAmount        = "TXN002"
	CodeTransactionCurrencyMismatch     = "TXN003"
	CodeTransactionInvalidKind          = "TXN004"
	CodeTransactionSameWallet           = "TXN005"
	CodeTransactionCategoryKindMismatch = "TXN006"
	CodeTransactionWalletArchived       = "TXN007"
	...
	CodePeriodInvalidRange    = "PRD003"
	CodePeriodOverlap         = "PRD004"
